...
#line 52 "src/parser/genlib/genlib_parser.tab.cc"
...
namespace gl {
#line 144 "src/parser/genlib/genlib_parser.tab.cc"
...
#line 738 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 5: // def_list: def_list def
...
#line 744 "src/parser/genlib/genlib_parser.tab.cc"
    break;
...
#line 750 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 7: // def: latch_def
...
#line 756 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 8: // latch_def: LATCH "ident"
...
#line 762 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 9: // gate_def: GATE "ident" FLOAT "ident" "=" qident ";" pin_def_list
...
#line 768 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 10: // pin_def_list: %empty
#line 88 "src/parser/genlib/genlib_parser.yy"
                      {}
#line 774 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 11: // pin_def_list: pin_def
...
#line 780 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 12: // pin_def_list: pin_def_list pin_def
...
#line 786 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 13: // pin_def: PIN "ident" "ident" FLOAT FLOAT FLOAT FLOAT FLOAT FLOAT
...
#line 793 "src/parser/genlib/genlib_parser.tab.cc"
  ...
  case 14: // pin_def: PIN "*" "ident" FLOAT FLOAT FLOAT FLOAT FLOAT FLOAT
...
#line 800 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 15: // qident: %empty
#line 103 "src/parser/genlib/genlib_parser.yy"
                 {}
#line 806 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 16: // qident: "ident"
#line 104 "src/parser/genlib/genlib_parser.yy"
                { yylhs.value.as < std::string > () = yystack_[0].value.as < std::string > (); }
#line 812 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 17: // qident: qident
#line 105 "src/parser/genlib/genlib_parser.yy"
                 { yylhs.value.as < std::string > () = yystack_[0].value.as < std::string > (); }
#line 818 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 18: // qident: qident "ident"
...
#line 824 "src/parser/genlib/genlib_parser.tab.cc"
  ...
  case 19: // qident: qident "*"
#line 107 "src/parser/genlib/genlib_parser.yy"
                     { yylhs.value.as < std::string > () = std::move(yystack_[1].value.as < std::string > ()) + "*"; }
#line 830 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 20: // qident: qident "+"
#line 108 "src/parser/genlib/genlib_parser.yy"
                     { yylhs.value.as < std::string > () = std::move(yystack_[1].value.as < std::string > ()) + "+"; }
#line 836 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 21: // qident: qident "("
#line 109 "src/parser/genlib/genlib_parser.yy"
                     { yylhs.value.as < std::string > () = std::move(yystack_[1].value.as < std::string > ()) + "("; }
#line 842 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 22: // qident: qident ")"
#line 110 "src/parser/genlib/genlib_parser.yy"
                     { yylhs.value.as < std::string > () = std::move(yystack_[1].value.as < std::string > ()) + ")"; }
#line 848 "src/parser/genlib/genlib_parser.tab.cc"
    break;

  case 23: // qident: qident "!"
#line 111 "src/parser/genlib/genlib_parser.yy"
                     { yylhs.value.as < std::string > () = std::move(yystack_[1].value.as < std::string > ()) + "!"; }
#line 854 "src/parser/genlib/genlib_parser.tab.cc"
    break;


#line 858 "src/parser/genlib/genlib_parser.tab.cc"
...
#undef YYCASE_
  ...
  "\")\"", "\"+\"", "\"*\"", "\"!\"", "\",\"", "\":\"", "\";\"", "GATE",
  "LATCH", "PIN", "\"ident\"", "FLOAT", "$accept", "genlib", "def_list",
  "def", "latch_def", "gate_def", "pin_def_list", "pin_def", "qident", YY_NULLPTR
  };
#endif
...
#line 1345 "src/parser/genlib/genlib_parser.tab.cc"
