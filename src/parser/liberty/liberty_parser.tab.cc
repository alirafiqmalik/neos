...
#line 52 "src/parser/liberty/liberty_parser.tab.cc"
...
namespace ll {
#line 144 "src/parser/liberty/liberty_parser.tab.cc"
...
#line 737 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 4: // node: node_assignment
...
#line 743 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 5: // node: node_property
...
#line 749 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 6: // node: named_node
...
#line 755 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 7: // node_list: %empty
#line 78 "src/parser/liberty/liberty_parser.yy"
                   {}
#line 761 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 8: // node_list: node
...
#line 767 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 9: // node_list: node_list node
...
#line 773 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 10: // named_node: "ident" "(" qident_list ")" "{" node_list "}"
...
#line 779 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 11: // named_node: "ident" "(" qident_list ")"
...
#line 785 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 12: // qident: "ident"
#line 89 "src/parser/liberty/liberty_parser.yy"
                { yylhs.value.as < std::string > () = yystack_[0].value.as < std::string > (); }
#line 791 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 13: // qident: QSTRING
#line 90 "src/parser/liberty/liberty_parser.yy"
                  { yylhs.value.as < std::string > () = yystack_[0].value.as < std::string > (); }
#line 797 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 14: // qident: qident QSTRING
#line 91 "src/parser/liberty/liberty_parser.yy"
                         { yylhs.value.as < std::string > () = yystack_[1].value.as < std::string > () + yystack_[0].value.as < std::string > (); }
#line 803 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 15: // qident: qident "ident"
#line 92 "src/parser/liberty/liberty_parser.yy"
                       { yylhs.value.as < std::string > () = yystack_[1].value.as < std::string > () + yystack_[0].value.as < std::string > (); }
#line 809 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 16: // qident: qident "/"
#line 93 "src/parser/liberty/liberty_parser.yy"
                     { yylhs.value.as < std::string > () = yystack_[1].value.as < std::string > () + "/"; }
#line 815 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 17: // qident: qident "*"
#line 94 "src/parser/liberty/liberty_parser.yy"
                     { yylhs.value.as < std::string > () = yystack_[1].value.as < std::string > () + "*"; }
#line 821 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 18: // qident_list: %empty
#line 97 "src/parser/liberty/liberty_parser.yy"
                     {}
#line 827 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 19: // qident_list: qident
...
#line 833 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 20: // qident_list: qident_list "," qident
...
#line 839 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 21: // node_assignment: qident "=" qident
...
#line 845 "src/parser/liberty/liberty_parser.tab.cc"
    break;

  case 22: // node_property: qident ":" qident
...
#line 851 "src/parser/liberty/liberty_parser.tab.cc"
    break;


#line 855 "src/parser/liberty/liberty_parser.tab.cc"
...
#undef YYCASE_
  ...
  "\")\"", "\"{\"", "\"}\"", "\"&\"", "\"|\"", "\"*\"", "\",\"", "\":\"",
  "\";\"", "\"ident\"", "QSTRING", "NUMBER", "\"/\"", "$accept", "liberty",
  "node", "node_list", "named_node", "qident", "qident_list",
  "node_assignment", "node_property", YY_NULLPTR
  };
#endif
...
#line 1336 "src/parser/liberty/liberty_parser.tab.cc"
