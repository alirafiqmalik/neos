...
#line 60 "src/parser/verilog/verilog_parser.tab.hh"
...
namespace vv {
#line 208 "src/parser/verilog/verilog_parser.tab.hh"
...
#ifdef VVSTYPE
# ifdef __GNUC__
#  pragma GCC message "bison: do not #define VVSTYPE in C++, use %define api.value.type"
# endif
    typedef VVSTYPE value_type;
#else
...
# endif
    ...
    {
      VV_ASSERT (yytypeid_);
      VV_ASSERT (*yytypeid_ == *that.yytypeid_);
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_VVerror = 256,             // error
    TOK_VVUNDEF = 257,             // "invalid token"
    TOK_ASSIGN = 258,              // "="
    TOK_LPAREN = 259,              // "("
    TOK_RPAREN = 260,              // ")"
    TOK_LBRACE = 261,              // "["
    ...
    TOK_COLON = 268,               // ":"
    TOK_POUND = 269,               // "#"
    TOK_ENDMODULEKW = 270,         // ENDMODULEKW
    TOK_MODULEKW = 271,            // MODULEKW
    TOK_ASSIGNKW = 272,            // ASSIGNKW
    TOK_IDENT = 273,               // "ident"
    TOK_PRIMGATE = 274,            // "primitive_gate"
    TOK_PORTATT = 275,             // "variable_attribute"
    TOK_PORTDIR = 276,             // "port_direction"
    TOK_INTEGER = 277,             // INTEGER
    TOK_CONSTHEX = 278,            // "hex_constant"
    TOK_CONSTBIN = 279,            // "bin_constant"
    TOK_CONSTDEC = 280,            // "dec_constant"
    TOK_CONSTSTR = 281             // "str_constant"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_COLON = 13,                            // ":"
        S_POUND = 14,                            // "#"
        S_ENDMODULEKW = 15,                      // ENDMODULEKW
        S_MODULEKW = 16,                         // MODULEKW
        S_ASSIGNKW = 17,                         // ASSIGNKW
        S_IDENT = 18,                            // "ident"
        S_PRIMGATE = 19,                         // "primitive_gate"
        S_PORTATT = 20,                          // "variable_attribute"
        S_PORTDIR = 21,                          // "port_direction"
        S_INTEGER = 22,                          // INTEGER
        S_CONSTHEX = 23,                         // "hex_constant"
        S_CONSTBIN = 24,                         // "bin_constant"
        S_CONSTDEC = 25,                         // "dec_constant"
        S_CONSTSTR = 26,                         // "str_constant"
        S_YYACCEPT = 27,                         // $accept
        S_verilog = 28,                          // verilog
        S_module = 29,                           // module
        S_module_header = 30,                    // module_header
        S_module_port_decl_list = 31,            // module_port_decl_list
        S_module_port_decl = 32,                 // module_port_decl
        S_statement_list = 33,                   // statement_list
        S_statement = 34,                        // statement
        S_net_decl_stmt = 35,                    // net_decl_stmt
        S_var_decl = 36,                         // var_decl
        S_ranged_var_decl = 37,                  // ranged_var_decl
        S_multi_var_decl = 38,                   // multi_var_decl
        S_instance_stmt = 39,                    // instance_stmt
        S_param_config = 40,                     // param_config
        S_constant_expr = 41,                    // constant_expr
        S_prim_gate_stmt = 42,                   // prim_gate_stmt
        S_assignment_stmt = 43,                  // assignment_stmt
        S_expr_list = 44,                        // expr_list
        S_expr = 45,                             // expr
        S_ranged_expr = 46,                      // ranged_expr
        S_indexed_expr = 47,                     // indexed_expr
        S_concat_expr = 48,                      // concat_expr
        S_range = 49,                            // range
        S_conn_pair = 50,                        // conn_pair
        S_conn_pair_list = 51,                   // conn_pair_list
        S_ident_list = 52                        // ident_list
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        VV_ASSERT (tok == token::TOK_END
                   || (token::TOK_VVerror <= tok && tok <= token::TOK_ASSIGNKW));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        VV_ASSERT (tok == token::TOK_CONSTBIN);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        VV_ASSERT (tok == token::TOK_CONSTDEC);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        VV_ASSERT (tok == token::TOK_CONSTHEX);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        VV_ASSERT (tok == token::TOK_INTEGER);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        VV_ASSERT ((token::TOK_IDENT <= tok && tok <= token::TOK_PORTDIR)
                   || tok == token::TOK_CONSTSTR);
#endif
      }
    };
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_VVerror (location_type l)
      {
        return symbol_type (token::TOK_VVerror, std::move (l));
      }
#else
      static
      symbol_type
      make_VVerror (const location_type& l)
      {
        return symbol_type (token::TOK_VVerror, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_VVUNDEF (location_type l)
      {
        return symbol_type (token::TOK_VVUNDEF, std::move (l));
      }
#else
      static
      symbol_type
      make_VVUNDEF (const location_type& l)
      {
        return symbol_type (token::TOK_VVUNDEF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 3020 "src/parser/verilog/verilog_parser.tab.hh"
